...
/**
 * This element implementation just outputs the whole data string
 * represented by a variable without any modifications.<br/>
 * <i>This is the most basic appliance I could think of and therefore
	...
	implements IElement 
{
	 ...
	 *  The class logger
	 */
	//private static final Log logger = LogFactory.getLog(BasicElement.class);
	 ...
	 */
	public BasicElement(String element,  String key) {
